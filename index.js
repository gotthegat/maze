...
const cellsHorizontal = 14; // columns
const cellsVertical = 10; // rows

const unitLengthX = width / cellsHorizontal; //width of side of a cell
const unitLengthY = height / cellsVertical; //height of side of a cell
